...
export default function ChatPanel() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] bg-gray-50">
      {/* Mobile history overlay backdrop */}
      {historyOpen && (
        <div
      ...
      <div className={`
        fixed inset-y-0 left-0 z-40 w-72 flex-shrink-0 border-r border-gray-200 bg-white flex flex-col transition-transform duration-200
        lg:relative lg:z-0 lg:w-64 lg:translate-x-0
        ${historyOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
      `}>
        <div className="p-3 border-b border-gray-200 flex items-center gap-2">
          <button
            onClick={newChat}
            className="flex-1 px-3 py-2 bg-teal-600 text-white rounded-lg text-sm font-medium hover:bg-teal-700 transition flex items-center justify-center gap-2"
          >
